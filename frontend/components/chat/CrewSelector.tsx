  ...
  return (
    <div className="relative inline-block text-left" ref={containerRef}>
      ...
      <button
        ...
        disabled={disabled}
        className={cn(
          "flex items-center gap-2.5 px-3 py-1.5 rounded-xl border transition-all duration-200 text-left group",
          isOpen
      ...
      >
        <div className="h-6 w-6 rounded-lg bg-accent/15 border border-accent/30 flex items-center justify-center text-accent shrink-0 group-hover:scale-105 transition-transform duration-200">
        ...
        <ChevronDown
          className={cn(
            "h-4 w-4 text-text-secondary transition-transform duration-200 shrink-0",
      ...
      {isOpen && (
        <div className={cn(
          "absolute left-0 mt-2 w-[340px] sm:w-[420px] rounded-2xl bg-bg-primary/95 backdrop-blur-xl border border-border shadow-2xl z-60 overflow-hidden",
              ...
              filteredCrews.map((c) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "w-full text-left p-3 rounded-xl border transition-all duration-200 flex items-start gap-3 group/item",
                      isSelected
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        "h-8 w-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5 transition-colors duration-200",
                        isSelected
